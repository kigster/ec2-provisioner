...
describe Provisioner::Command::Provision do
  let(:configuration) { Provisioner::Configuration.from_path('spec/fixtures/ec2.yml') }
  ...
  describe '#shell_commands' do
    context 'host is specified' do
      ...
      context 'passing options directly' do
        ...
        context 'ssh_key are included' do
          it 'passes ssh_key to knife-ec2' do
            template_configuration[:ssh_key] = {a: 1, b: 2, c: 3}
            command_options << "--ssh_key '{\"a\":1,\"b\":2,\"c\":3}'"
