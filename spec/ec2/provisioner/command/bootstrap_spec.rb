...
describe EC2::Provisioner::Command::Bootstrap do
  describe '#shell_commands' do
    let(:template_configuration) { {
        ...
        subnet: 'smartos-base64',
        security_group_id: '42325ea0-eb62-44c1-8eb6-0af3e2f83abc,c8cde927-6277-49ca-82a3-741e8b23b02f',
        host_sequence: '1..2',
        host_suffix: 'test',
        host_presuffix: 'c1',
    ...
    before do
      allow_any_instance_of(EC2::Provisioner::Command::Bootstrap::HostCommand).to receive(:ip_for_host) { '1.2.3.4' }
    end

    context 'host is specified' do

      let(:subject) { EC2::Provisioner::Command::Bootstrap.new(template_configuration, number: '1') }
    ...
    context 'ssh user is overridden' do
      let(:subject) { EC2::Provisioner::Command::Bootstrap.new(template_configuration, number: '1', ssh_user: 'root') }
    ...
    context 'reset is true' do
      let(:subject) { EC2::Provisioner::Command::Bootstrap.new(template_configuration, number: '1', ssh_user: 'root', reset: true) }
    ...
    context 'sudo is true' do
      let(:subject) { EC2::Provisioner::Command::Bootstrap.new(template_configuration, number: '1', ssh_user: 'root', sudo: true) }
